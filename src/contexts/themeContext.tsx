...
export const Themes = {
  Default: ["#FC4C02", "#E8112D", "#FF6B35", "#FFA500", "#FFD700", "#FF1744", "#D84315", "#BF360C", "#FF8A65", "#FFAB91", "#8D6E63", "#6D4C41", "#5D4037"],
  ...
  Teal: ["#06d6a0", "#20aaa1", "#198190", "#0e5d72", "#073b4c", "#456c78", "#739099", "#96abb2", "#b1c0c5", "#c4d0d3", "#d6dfe1", "#e0e7e8", "#e8edee"]
} as const
